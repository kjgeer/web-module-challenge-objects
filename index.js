...
const changeReview = function(array, index, key, string){
  array[index][key] = string;
  return array;
}

console.log(changeReview(reviews, 7, 'feedback', "this place is chill with really cool people, great for getting work done on weekdays"));    
